    ...
    <div className="relative h-full">
      ...
      {isCollapsed && (
        <button
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 z-20 w-10 h-16 bg-[var(--color-surface)] border border-r border-[var(--color-border)] rounded-r-lg shadow-lg flex items-center justify-center hover:bg-[var(--color-bg)] transition-colors"
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="flex flex-col gap-1">
                      <label className="font-medium text-xs text-[var(--color-text-muted)]">Min Lat</label>
                      <div className="px-3 py-2 bg-[var(--color-bg)] rounded border border-[var(--color-border)]">
                        {bbox.minLat.toFixed(6)}
                      </div>
                    </div>
                    <div className="flex flex-col gap-1">
                      <label className="font-medium text-xs text-[var(--color-text-muted)]">Min Lng</label>
                      <div className="px-3 py-2 bg-[var(--color-bg)] rounded border border-[var(--color-border)]">
                        {bbox.minLng.toFixed(6)}
                      </div>
                    </div>
                    <div className="flex flex-col gap-1">
                      <label className="font-medium text-xs text-[var(--color-text-muted)]">Max Lat</label>
                      <div className="px-3 py-2 bg-[var(--color-bg)] rounded border border-[var(--color-border)]">
                        {bbox.maxLat.toFixed(6)}
                      </div>
                    </div>
                    <div className="flex flex-col gap-1">
                      <label className="font-medium text-xs text-[var(--color-text-muted)]">Max Lng</label>
                      <div className="px-3 py-2 bg-[var(--color-bg)] rounded border border-[var(--color-border)]">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-3 py-1 text-xs border border-[var(--color-border)] rounded hover:bg-[var(--color-bg)] transition-colors"
                      >
                        Copy
                      </button>
                    </div>
                    <code className="block text-xs bg-[var(--color-bg)] rounded p-2 border border-[var(--color-border)] break-all">
